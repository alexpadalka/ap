...
import static ap.lesson01_lambdas.util.RandomUtility.generateRandomDouble;
import static ap.lesson01_lambdas.util.RandomUtility.generateRandomInteger;
...
import ap.lesson01_lambdas.task06.A;
...
public class Utility {
  ...
  public static Author[] populateAuthorsWithoutBooks(int size) {
    ...
    IntStream.range(0, size)
        .forEach(
            i -> {
              String name = RandomUtility.generateRandomString(20);
  ...
  public static Book[] populateBooksWithoutAuthors(int size) {
    ...
    IntStream.range(0, size)
        .forEach(
            i -> {
              String title = RandomUtility.generateRandomString(50);
  ...
  public static A createA() {
    ...
    a.setB(RandomUtility.generateRandomBoolean());
    a.setD(RandomUtility.generateRandomDouble());
    a.setI(RandomUtility.generateRandomInteger());
    a.setS(RandomUtility.generateRandomString(10));
